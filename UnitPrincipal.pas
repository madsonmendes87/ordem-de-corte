...
//              popupAcao.Items.Find('Reabrir').Enabled:=false;
          ...
          begin
              ...
              formRealCortado.popupArtigos.Items.Find('Adicionar Primário').Enabled             :=false;
              formRealCortado.popupArtigos.Items.Find('Adicionar Secundário').Enabled           :=false;
...
//              popupAcao.Items.Find('Finalizar').Enabled:=false;
          ...
          formRealCortado.gridRealCortado.Columns[0].Title.Caption:='Nº Real Cortado';
          formRealCortado.gridRealCortado.Columns[1].Title.Alignment:=taCenter;
          formRealCortado.gridRealCortado.Columns[1].Title.Caption:='Situação';
          ...
          formRealCortado.gridRealCortado.Columns[3].Title.Caption:='Cód Produto';
          ...
          formRealCortado.gridRealCortado.Columns[5].Title.Caption:='Composição';
