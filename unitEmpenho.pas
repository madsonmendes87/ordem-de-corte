...
begin
    ...
    gridArtigo.Columns[3].Title.Caption           :='Código';
    ...
    gridArtigo.Columns[10].Title.Caption          :='Cor Referência';
    ...
    gridArtigo.Columns[13].Title.Caption          :='Disponível';
