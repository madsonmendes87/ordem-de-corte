...
begin
    ...
    begin
     ...
     begin
         ...
         begin
            ShowMessage('PRODUTO VIRTUAL' +
                        'PRODUTO: ' + dmOrdemCorte.qyAviamentosPorFicha.FieldByName('cp_descricao').Value +
                        'COR: ' + dmOrdemCorte.qyAviamentosPorFicha.FieldByName('grc_nome').Value +
