...
begin
    ...
    formPrevisto.Show;
    formPrevisto.labNumCorte.Caption := intToStr(gridOrdem.Fields[0].Value) +'-00'+ intToStr(gridOrdem.Fields[1].Value);
    ...
    begin
        ...
        Open;
        if gridOrdem.Fields[8].Value = 'Grande Escala' then
        begin
            if dmOrdemCorte.qyOrdemPrototipo.RecordCount > 0 then
            begin
                formPrevisto.butPrototipo.Visible := true;
                formPrevisto.labPrototipo.Visible := true;
                formPrevisto.labPrototipo.Caption := 'Protótipo: '+intToStr(dmOrdemCorte.qyOrdemPrototipo.FieldByName('oc_id').Value)+'-00'+
                intToStr(dmOrdemCorte.qyOrdemPrototipo.FieldByName('oc_ordem').Value);
            end;
            if dmOrdemCorte.qyOrdemPrototipo.RecordCount = 0 then
            begin
                formPrevisto.butPrototipo.Visible := false;
                formPrevisto.labPrototipo.Visible := false;
            end;
        end;
        if gridOrdem.Fields[8].Value = 'Prototipo' then
        begin
            formPrevisto.butPrototipo.Visible := false;
            formPrevisto.labPrototipo.Visible := false;
        end;
    ...
    begin
        ...
        begin
            formPrevisto.labStatuSituacao.Caption := dmOrdemCorte.qyStatusPrevisto.FieldByName('descricao').Value;
            formPrevisto.labStatuSituacao.Font.Color := clRed;
        end;
        if dmOrdemCorte.qyStatusPrevisto.FieldByName('oci_situacao_id').Value = 3 then
        begin
            formPrevisto.labStatuSituacao.Caption := 'SOB EMPENHO';
            formPrevisto.labStatuSituacao.Font.Color := clOlive;
        end;
        if dmOrdemCorte.qyStatusPrevisto.FieldByName('oci_situacao_id').Value = 4 then
        begin
            formPrevisto.labStatuSituacao.Caption := dmOrdemCorte.qyStatusPrevisto.FieldByName('descricao').Value;
            formPrevisto.labStatuSituacao.Font.Color := clNavy;
        end;
    end;
    if gridOrdem.Fields[8].Value = 'Prototipo' then
       formPrevisto.panelCabecalho.Caption := 'Corte Previsto - Protótipo'
    else
        formPrevisto.panelCabecalho.Caption := 'Corte Previsto - Grande Escala';
    ...
    begin
        ...
        ParamByName('ficha').AsInteger:=strtoint(gridOrdem.Fields[5].Value);
        Open;
        if dmOrdemCorte.qyFichaIdCorte.RecordCount > 0 then
        begin
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam1').Value = '' then
            begin
                formPrevisto.labTam1.Visible:=false;
                formPrevisto.spinTamanho1.Visible:=false;
                formPrevisto.labIndividual1.Visible:=false;
                formPrevisto.labTotal1.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam1.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam1').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam2').Value = '' then
            begin
                formPrevisto.labTam2.Visible:=false;
                formPrevisto.spinTamanho2.Visible:=false;
                formPrevisto.labIndividual2.Visible:=false;
                formPrevisto.labTotal2.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam2.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam2').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam3').Value = '' then
            begin
                formPrevisto.labTam3.Visible:=false;
                formPrevisto.spinTamanho3.Visible:=false;
                formPrevisto.labIndividual3.Visible:=false;
                formPrevisto.labTotal3.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam3.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam3').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam4').Value = '' then
            begin
                formPrevisto.labTam4.Visible:=false;
                formPrevisto.spinTamanho4.Visible:=false;
                formPrevisto.labIndividual4.Visible:=false;
                formPrevisto.labTotal4.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam4.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam4').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam5').Value = '' then
            begin
                formPrevisto.labTam5.Visible:=false;
                formPrevisto.spinTamanho5.Visible:=false;
                formPrevisto.labIndividual5.Visible:=false;
                formPrevisto.labTotal5.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam5.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam5').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam6').Value = '' then
            begin
                formPrevisto.labTam6.Visible:=false;
                formPrevisto.spinTamanho6.Visible:=false;
                formPrevisto.labIndividual6.Visible:=false;
                formPrevisto.labTotal6.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam6.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam6').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam7').Value = '' then
            begin
                formPrevisto.labTam7.Visible:=false;
                formPrevisto.spinTamanho7.Visible:=false;
                formPrevisto.labIndividual7.Visible:=false;
                formPrevisto.labTotal7.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam7.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam7').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam8').Value = '' then
            begin
                formPrevisto.labTam8.Visible:=false;
                formPrevisto.spinTamanho8.Visible:=false;
                formPrevisto.labIndividual8.Visible:=false;
                formPrevisto.labTotal8.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam8.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam8').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam9').Value = '' then
            begin
                formPrevisto.labTam9.Visible:=false;
                formPrevisto.spinTamanho9.Visible:=false;
                formPrevisto.labIndividual9.Visible:=false;
                formPrevisto.labTotal9.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam9.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam9').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam10').Value = '' then
            begin
                formPrevisto.labTam10.Visible:=false;
                formPrevisto.spinTamanho10.Visible:=false;
                formPrevisto.labIndividual10.Visible:=false;
                formPrevisto.labTotal10.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam10.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam10').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam11').Value = '' then
            begin
                formPrevisto.labTam11.Visible:=false;
                formPrevisto.spinTamanho11.Visible:=false;
                formPrevisto.labIndividual11.Visible:=false;
                formPrevisto.labTotal11.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam11.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam11').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam12').Value = '' then
            begin
                formPrevisto.labTam12.Visible:=false;
                formPrevisto.spinTamanho12.Visible:=false;
                formPrevisto.labIndividual12.Visible:=false;
                formPrevisto.labTotal12.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam12.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam12').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam13').Value = '' then
            begin
                formPrevisto.labTam13.Visible:=false;
                formPrevisto.spinTamanho13.Visible:=false;
                formPrevisto.labIndividual13.Visible:=false;
                formPrevisto.labTotal13.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam13.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam13').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam14').Value = '' then
            begin
                formPrevisto.labTam14.Visible:=false;
                formPrevisto.spinTamanho14.Visible:=false;
                formPrevisto.labIndividual14.Visible:=false;
                formPrevisto.labTotal14.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam14.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam14').Value;
            end;
            if dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam15').Value = '' then
            begin
                formPrevisto.labTam15.Visible:=false;
                formPrevisto.spinTamanho15.Visible:=false;
                formPrevisto.labIndividual15.Visible:=false;
                formPrevisto.labTotal15.Visible:=false;
            end
            else
            begin
                formPrevisto.labTam15.Caption:=dmOrdemCorte.qyFichaIdCorte.FieldByName('fti_tam15').Value;
            end;
        end;
    end;
    desabComponentes;
