...
begin
    ...
    begin
        noReferencia            :=treeInfoReferencia.Items.Add(nil, 'REFERÊNCIA: '+ qyInfoReferencia.FieldByName('cad_idreferencia').Value);
        ...
        if qyInfoReferencia.FieldByName('oc_prototipo').Value = true then
            noPrototipo         :=treeInfoReferencia.Items.AddChild(noReferencia, 'TIPO PRODUÇÃO: Protótipo')
        else
            noPrototipo         :=treeInfoReferencia.Items.AddChild(noReferencia, 'TIPO PRODUÇÃO: Grande Escala');
        ...
        noComposicao            :=treeInfoReferencia.Items.AddChild(noReferencia, 'COMPOSIÇÃO: '+qyInfoReferencia.FieldByName('cm_descricao').Value);
