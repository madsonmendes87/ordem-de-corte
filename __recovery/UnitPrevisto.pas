...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                labPrototipo.Caption := 'Protótipo: '+intToStr(dmOrdemCorte.qyOrdemPrototipo.FieldByName('oc_id').Value)+'-00'+
    ...
    gridPrevisto.Columns[0].Title.Caption:='Nº Previsto';
    gridPrevisto.Columns[1].Title.Alignment:=taCenter;
    gridPrevisto.Columns[1].Title.Caption:='Situação';
    ...
    gridPrevisto.Columns[3].Title.Caption:='Cód Produto';
