...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                Application.MessageBox('Já existe uma ordem de corte protótipo para essa referencia!', 'Ordem de Corte', mb_ok + mb_iconexclamation);
                exit;
            end
            else
                with application do
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    Application.MessageBox('Prototipo em espera por aprovação!', 'Ordem de Corte', mb_ok + mb_iconexclamation);
                    exit;
                end;
                if dmOrdemCorte.qyGEComOuSemProt.FieldByName('fp_situacao').Value = 'R' then
                begin
                    Application.MessageBox('Protótipo reprovado, por esse motivo produção não pode ser realizada', 'Ordem de Corte', mb_ok + mb_iconhand);
                    exit;
                end;
            end
            else
